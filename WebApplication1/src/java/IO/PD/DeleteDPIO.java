...
public class DeleteDPIO {
    ...
    public Product checkDelete(String id){     
        try {
            ...
            {
                Product a = new Product(rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(5),
                        rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10),
                        rs.getString(11),rs.getString(12),rs.getString(13),rs.getString(14),rs.getString(15)); //xét giá trị a
