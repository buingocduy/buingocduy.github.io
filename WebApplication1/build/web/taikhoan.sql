...
Create table hang
(tenhang nvarchar(30),primary key(tenhang)) 
go
...
CC char(20),congsuat nvarchar(50),CCnhot nvarchar(50),CCxang nvarchar(20),phanh nvarchar(50),gear nvarchar(20),tenhang nvarchar(30),primary key(id))
go
...
insert into hang values ('HONDA')
insert into hang values ('YAMAHA')
insert into hang values ('SUZUKI')
go


insert into sanpham values ('Click 2020','85','Hinh\vario.jpg',
...
insert into sanpham values ('Winner X','45','Hinh\winnerx.jpg',
...
insert into sanpham values ('CB150R SF','85','Hinh\CB150RSF.jpg',
...
insert into sanpham values ('Air Blade','50','Hinh\airblade.jpg',
...
insert into sanpham values ('Monkey 2020','85','Hinh\monkey.jpg',
...
insert into sanpham values ('SH 2020','71','Hinh\SH.jpg',
...
update sanpham set hang = 'YAMAHA' where id = '3'

delete from sanpham where id = '2'
