...
public class frmLoaiSach extends javax.swing.JFrame {
    ...
    CategoryServices catService = new CategoryServices();
    /**
    ...
    public frmLoaiSach() {
        ...
        //set form title
        this.setTitle("Quản lý thông tin loại sách");
        //show list tác giả
        showDataList();;
    }
    ...
    private void initComponents() {
        ...
        btnAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/add1.png"))); // NOI18N
        btnAdd.setText("Thêm");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        int rowEffected = catService.AddNewRecord(categoyName);
        if(rowEffected > 0){
            showDataList();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        //goi ham trong package "bookstore.dal"
        int rowEffected = catService.UpdateRecord(Integer.valueOf(categoryID), categoryName);
        if(rowEffected > 0){
            showDataList();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(input == 0)
        {
            //Xoa
            //goi ham trong package "bookstore.dal"
            int rowEffected = catService.DeleteRecord(Integer.valueOf(categoryID));
            if(rowEffected > 0){
                showDataList();
    ...
    private void showDataList(){
        ...
        //load data
        ArrayList<Category> list = catService.getAllRecords();
    ...
    private void showDataDetail(int categoryID, String categoryName){
