...
public class Banhang extends javax.swing.JFrame {
    ...
    public void XuatHoaDon(int MaHD)
    {
        try {
            ...
            JasperDesign jd = JRXmlLoader.load("\\BuiNgocDuy\\QuanLyXe\\src\\quanlyxe\\baocao\\XuatHoaDon.jrxml");       
            JasperReport jr = JasperCompileManager.compileReport("\\BuiNgocDuy\\QuanLyXe\\src\\quanlyxe\\baocao\\XuatHoaDon.jrxml");  
            
            map.put("MaHoaDon",MaHD);
            JasperPrint jp = JasperFillManager.fillReport(jr, map, sql.getConnection());
            JasperViewer.viewReport(jp,false);     
            JasperExportManager.exportReportToPdfFile(jp,"\\BuiNgocDuy\\QuanLyXe\\src\\quanlyxe\\baocao\\XuatHoaDon.pdf");
