...
public class sanphamXL {
    ...
    public int AddNewRecord(String ID, String Name, String categoryID, String supplierID, String publishingYear){
        ...
        try{
            ...
            hienthi_sql acc = new hienthi_sql();
            String sql = "INSERT INTO sanpham (MaSP, TenSP, Maloai, MaNCC, Namsanxuat) VALUES('" + ID + "'" +
                    ",N'" + Name +"'"+ 
                    ", '" + categoryID + "'"+
                    ", '" + supplierID + "'"+                   
                    ", '" + publishingYear   +"')";                    
    ...
    //Cap nhat
    public int UpdateRecord(String ID, String Name, String categoryID, String supplierID, String publishingYear){
        int rowCount = 0;
        try{
